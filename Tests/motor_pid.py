...
# Настройки BTS7960
RPWM_PIN = 18       # Пин для правого PWM (GPIO18)
LPWM_PIN = 19       # Пин для левого PWM (GPIO19)
R_EN_PIN = 23       # Пин включения правого направления
L_EN_PIN = 24       # Пин включения левого направления
